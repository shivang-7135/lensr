      ...
      {!!data.picks?.length && (
        <div className="grid sm:grid-cols-2 gap-4">
          {data.picks.map((e, i) => {
            const isTop =
              data.recommendation &&
              e.title.toLowerCase().includes(data.recommendation.toLowerCase());
            ...
            return (
              ...
              >
                <div className="relative aspect-[16/9] bg-white/5 overflow-hidden">
                  ...
                  />
                  {e.category && (
                    <span className="absolute top-2 right-2 text-xs font-semibold px-2 py-1 rounded-full glass-strong">
                      {e.category}
                    </span>
                  )}
                  {isTop && (
                ...
                <div className="p-4 space-y-2 flex-1 flex flex-col">
                  ...
                  {e.why_recommended && (
                    <p className="text-sm leading-relaxed">{e.why_recommended}</p>
                  )}
                  {href && (
                    <a
                      href={href}
                    ...
                    >
                      ...
                      {e.tickets_url ? "Get tickets" : "Event details"}
                    </a>
                  )}
                </div>
              </article>
